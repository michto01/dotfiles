...
export ZSH=/Users/cre8iveu/.oh-my-zsh

# Set name of the theme to load.
# Look in ~/.oh-my-zsh/themes/
# Optionally, if you set this to "random", it'll load a random theme each
# time that oh-my-zsh is loaded.
ZSH_THEME="bullet-train" #"robbyrussell"

# BULLET THEME customizations
...
plugins=(colored-man-pages git colorize gem history history-substring-search terminallapp brew nanoc)
